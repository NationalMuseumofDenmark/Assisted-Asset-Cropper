...
//var simple_canny_algorithm = require('./cropping-algorithm-simple-canny.js');
//var advanced_canny_algorithm = require('./cropping-algorithm-advanced-canny.js');
var canny_with_solidity_algorithm = require('./cropping-algorithm-canny-with-solidity.js');
//var hue_canny_with_solidity_algorithm = require('./cropping-algorithm-hue-canny-with-solidity.js');
...
exports.thumbnail = function(client, catalog_alias, asset_id, x, y, width, height, size, success) {
	...
	client.get_asset(catalog_alias, asset_id, true, function(asset) {
		...
		success( cropping_details );
	});
}

var algorithm = canny_with_solidity_algorithm;
