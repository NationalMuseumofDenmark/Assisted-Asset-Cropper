...
a);console.trace()});a=this.named_parameters_with_defaults(a);c=this.generate_url(c,!1);if("undefined"!=typeof require&&request)return request.post({url:c,method:"POST",form:a,timeout:6E4,useQuerystring:!0},function(a,c,h){null==c||void 0==c?k(null)||g(null):a||200!=c.statusCode?void 0===k?(console.log("No error function defined, calling success(null) :("),g(null)):k(c.body||null):""===c.body?g(!0):g(JSON.parse(c.body))});if(qwest&&"object"===typeof qwest)return qwest.post(c,a,{async:p}).success(g).error(k)};
